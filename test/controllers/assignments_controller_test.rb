...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { content: @assignment.content, topic: @assignment.topic } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { content: @assignment.content, topic: @assignment.topic } }
